...
import db from './svnGraphAst'
import svnGraphParser from './parser/svnGraph'
...
export const draw = function (txt, id, ver) {
  try {
    const parser = svnGraphParser.parser
    parser.yy = db

    logger.debug('in svnGraph renderer', txt, id, ver)
    ...
    logger.error('Error while rendering svnGraph')
